...
| Upload de Exames | Produto | Inc6 | `exams`-escrita (definido, pré-impl) | — | [MOBILE-027](docs/MOBILE-027_READINESS_INCREMENTO6_UPLOAD.md) (Readiness + integração §7) | 🔄 **Em Implementação** |
