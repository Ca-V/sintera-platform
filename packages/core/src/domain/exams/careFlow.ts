// @sintera/core — Fluxo assistencial do exame (fundadora 15/07): a arquitetura prevê EXPLICITAMENTE as etapas
...
//
// Camada de DOMÍNIO: pura/determinística, sem IO. Fonte ÚNICA (Web + Mobile). Reutiliza o status do
// Evento Assistencial (planejado/realizado) e a existência de documento de pedido / de resultado.
