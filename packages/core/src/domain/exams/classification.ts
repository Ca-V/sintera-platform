// @sintera/core — Classificação Exame × Pedido/Solicitação (F4) — separa os dois objetos por documentType.
// Um "pedido" (medical_order) ou "guia de convênio" (insurance_guide) é uma SOLICITAÇÃO, com ciclo
// de vida distinto do exame realizado. Determinística; fonte ÚNICA (Web + Mobile).
