// @sintera/core — Parsing financeiro (valor em reais ⇄ centavos) — puro/determinístico. Fonte ÚNICA
// (Web + Mobile). Reutilizado pelo formulário de evento (financeiro do exame F8) e por quem exibir valores.
