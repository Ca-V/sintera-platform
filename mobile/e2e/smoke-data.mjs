...
const FIXTURES = {
  ...
  '/api/biomarkers/organized': { byCategory: { metabolismo_glicose: [{ id: 'b1', name: 'Glicose', displayName: 'Glicose', value: 90, valueText: '90', unit: 'mg/dL', rangeStatus: 'within' }] }, counts: { total: 1, categories: 1, outOfRange: 0 } },
