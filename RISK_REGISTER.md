...
| R-008 | Arquitetura / Mobile | **Divergência Web↔Mobile** (paridade) — implementações paralelas | **Monitorado** | Reutilizar contratos/validações/regras via `@sintera/*`; Matriz de Paridade; mandato de paridade. [PARIDADE_WEB_MOBILE](docs/PARIDADE_WEB_MOBILE.md) |
