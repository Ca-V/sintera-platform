...
describe('Home é composição, não dona de lógica de domínio (MOBILE-014 §2.1)', () => {
  ...
  it('encontra os componentes da Home (sanidade)', () => {
    ...
    for (const name of ['HomeShell.tsx', 'WelcomeSlot.tsx', 'AdicionarRegistroSlot.tsx', 'QuickActionsSlot.tsx', 'ProximosCompromissosSlot.tsx', 'ComoUsarSlot.tsx', 'FooterSlot.tsx']) {
