...
| E5 | **Categorias de exame** (incl. **ômicas como categorias**) | A4 / §2.6 | classificação aberta (Modelo Aberto) | categorias abertas/escaláveis; ômicas = categoria (sem fluxo próprio) | ⏸️ **decisão da fundadora** (contradição: módulo ômicas maduro c/ "fluxo próprio" × ajuste "sem fluxo próprio"; ver nota abaixo) |
