...
- **Propósito** *(por quê existimos — impacto na vida do usuário):* existimos para que cada pessoa tenha sua história de saúde **organizada, compreendida e sempre a serviço do seu cuidado**.
- **Missão** *(o que fazemos hoje):* transformar **informações de saúde dispersas** em uma **história de saúde organizada e contínua**, que permita **compreender e acompanhar melhor o cuidado ao longo da vida**.
- **Visão** *(o que queremos nos tornar):* construir a **plataforma de organização e continuidade da saúde** que acompanha **cada história ao longo de toda a vida**, tornando o cuidado mais simples, organizado e contínuo.
...
**Princípios de copy da landing:** (a) perspectiva no **usuário** ("você passa a…", não "a SINTERA faz…"); (b) **"história de saúde"** (concreto) no lugar de "continuidade" (abstrato), com **repetição controlada** — aparece poucas vezes (Hero · Ecossistema · fecho do CTA) e, nas demais seções, varia com "informações da sua saúde", "rotina de saúde", "acompanhamento da sua saúde", "evolução do seu cuidado"; (c) **IA nunca é protagonista** (é meio) — na confiança, foco é conteúdo preservado + controle do usuário, e a seção abre com **pergunta** ("Por que confiar suas informações de saúde à SINTERA?"), não afirmação; (d) recuperar sempre o diferencial constitucional **"a burocracia da saúde rouba tempo do cuidado"** ("menos tempo organizando, mais tempo cuidando"); (e) só afirmar o que está **live** (integrações labs/wearables ficam explicitamente como "em breve"); (f) a página **abre no Hero** (a peça mais importante, revisada à parte) e **fecha olhando para o futuro** ("cada informação registrada hoje torna sua história de saúde mais completa amanhã"). **Fonte:** componentes em `src/components/landing/`. Após esta reconstrução: **publicar e evoluir por métricas** (tempo na página · CTA · conversão), não por nova discussão conceitual.
