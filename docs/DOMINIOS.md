...
| **Eventos Assistenciais** (`EVT`) | 10/11 | 0 (1 baixa justif.) | Gates ✅ · Auditoria funcional (execução) pendente | Em andamento | `EVENTOS_CHECKLIST_FUNCIONAL.md` · `EVENTO_ASSISTENCIAL.md` |
...
**NCs abertas (crítica/alta) na plataforma: 0.** 1 baixa justificada/adiada (NC-0006, EventLink write-side).
Sequência global de NC: `NC-0006` é a última registrada.
