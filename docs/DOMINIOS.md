...
| **Eventos Assistenciais** (`EVT`) | 10/11 | 1 média (UX) | Gates ✅ · Auditoria funcional (execução) pendente | Em andamento | `EVENTOS_CHECKLIST_FUNCIONAL.md` · `EVENTO_ASSISTENCIAL.md` |
...
**NCs abertas (crítica/alta) na plataforma: 0.** Abertas: 1 média-UX (NC-0007, campos de evento não
surfacados — decisão de produto) · 1 baixa justificada (NC-0006, EventLink write-side). Última NC: `NC-0007`.
