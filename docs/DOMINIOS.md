...
| **Fase 0 — Compliance & Governança** (`COMP`) | 2 ✅ · 8 🟡 · 3 ⬜ (13) | 0 (2 exceções) | **Trilha PARALELA oficial** · Compliance Review ativo (gate 2 partes, **9 eixos** matriz = Definition of Done) | Em andamento (paralelo a Exames) | `COMPLIANCE-001` · `DATA-001` · `API-001` · `SEC-001` · `HIP-001` |
