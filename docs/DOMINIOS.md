...
| **Eventos Assistenciais** (`EVT`) | 11/11 | 9 (5 méd. + 4 baixa; 0 crít./alta) | Gates ✅ · Auditoria funcional (execução) pendente | Em andamento | `EVENTOS_CHECKLIST_FUNCIONAL.md` · `EVENTO_ASSISTENCIAL.md` |
...
**NCs abertas (crítica/alta) na plataforma: 0.** Total aberto: **13** (7 média + 6 baixa), descobertas na
auditoria estática aprofundada de Exames (NC-0008–0011) e Eventos (NC-0006–0007, 0012–0019). Nenhuma bloqueia
o Lifecycle; ~5 são justificadas/adiadas (Convergência Progressiva, roadmap multi-exame, vínculo duro). Por
Tipo: Dados 3 · Funcional 4 · UX 5 · Arquitetural 1. Última NC: `NC-0019`.
