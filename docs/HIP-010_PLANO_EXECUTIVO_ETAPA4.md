...
**autenticação** (Supabase Auth, sessão, deep links) · **Design System móvel** (tokens Van Gogh, componentes base) ·
**navegação** (bottom tabs — [[HIP-011]]) · **camada de comunicação com API** (cliente compartilhado, versionado).
