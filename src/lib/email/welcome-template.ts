          ...
          <tr>
            <td align="center" style="padding-bottom:32px;">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:linear-gradient(135deg,#3D6C7B,#488593);width:36px;height:36px;border-radius:50%;text-align:center;vertical-align:middle;">
                ...
                <tr>
                  <td align="center">
                    <a href="https://sinteramais.com.br/onboarding"
                      style="display:inline-block;background:linear-gradient(135deg,#3D6C7B,#488593);color:#fff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 36px;border-radius:50px;letter-spacing:0.04em;">
                      Acessar a SINTERA →
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:24px 8px 0;text-align:center;">
              <p style="margin:0 0 8px;font-size:12px;color:#B0A8B9;line-height:1.6;">
                ...
                <a href="https://sinteramais.com.br/privacidade" style="color:#488593;text-decoration:none;">Política de Privacidade</a>
