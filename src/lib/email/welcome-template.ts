...
<head>
  ...
  <title>Bem-vinda ao Beta da SINTERA</title>
</head>
          ...
          <tr>
            <td style="background:#FFFFFF;border-radius:20px;padding:40px 36px;box-shadow:0 2px 16px rgba(0,0,0,0.06);">
              ...
              <h1 style="margin:0 0 20px;font-size:26px;font-weight:700;color:#1C1C1E;line-height:1.3;">
                Olá, ${name}! Sua vaga no Beta está confirmada.
              </h1>

              <p style="margin:0 0 16px;font-size:15px;color:#5A5068;line-height:1.7;">
                Você está entre as primeiras pessoas a acessar a SINTERA — uma plataforma que organiza seus laudos laboratoriais com IA e transforma números em informação que você realmente entende.
              </p>

              <p style="margin:0 0 28px;font-size:15px;color:#5A5068;line-height:1.7;">
                Neste Beta, você pode:
              </p>
...
Sua vaga no Beta da SINTERA está confirmada.
