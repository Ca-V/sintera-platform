...
// PEDIDO-002 — `deriveOrderTitle` (título do pedido a partir dos procedimentos) foi movido para @sintera/core
// (`domain/exams/orderTitle`) para ser compartilhado por Web, Mobile e servidor.
