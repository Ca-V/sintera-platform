...
const PHASES: Phase[] = [
  ...
  { name: 'Folicular',  startDay: 6,  endDay: 13, color: '#7FC6BF', label: 'Dias 6–13', active: true },
...
const hormones = [
  ...
  { label: 'Progesterona', values: [8,8,9,10,12,14,16,18,22,28,35,42,50,58,65,70,75,78,80,76,68,58,45,30,20,14,10,8], color: '#7FC6BF' },
]
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="flex-shrink-0 mx-auto lg:mx-0">
          <svg viewBox="0 0 200 200" width="200" height="200">
            ...
            <text x={CX} y={CY + 20} textAnchor="middle" fontSize="8" fill="#157A6F" fontFamily="sans-serif">FOLICULAR</text>
