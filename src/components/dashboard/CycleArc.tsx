...
const PHASES: Phase[] = [
  { name: 'Menstrual',  startDay: 1,  endDay: 5,  color: '#B15C4C', label: 'Dias 1–5' },
  { name: 'Folicular',  startDay: 6,  endDay: 13, color: '#579DA8', label: 'Dias 6–13', active: true },
  { name: 'Ovulatória', startDay: 14, endDay: 16, color: '#7E9B6E', label: 'Dias 14–16' },
...
const hormones = [
  { label: 'Estrogênio', values: [20,30,45,65,80,95,72,50,40,35,38,42,46,48,50,48,45,42,38,35,32,30,28,26,24,22,20,18], color: '#B15C4C' },
  { label: 'Progesterona', values: [8,8,9,10,12,14,16,18,22,28,35,42,50,58,65,70,75,78,80,76,68,58,45,30,20,14,10,8], color: '#579DA8' },
]
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="flex-shrink-0 mx-auto lg:mx-0">
          <svg viewBox="0 0 200 200" width="200" height="200">
            ...
            <text x={CX} y={CY + 20} textAnchor="middle" fontSize="8" fill="#3D6C7B" fontFamily="sans-serif">FOLICULAR</text>
