...
export default function MedidasPage() {
  ...
  const groups: Metric[] = ['peso', 'altura', 'circunferencia_cintura', 'imc', 'gordura_corporal', 'massa_muscular', 'agua_corporal', 'gordura_visceral', 'massa_ossea', 'taxa_metabolica', 'outro']
