      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="card-premium p-8 space-y-8 font-body text-sm text-onyx/80 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>A SINTERA é fornecida &ldquo;como está&rdquo;. Não garantimos disponibilidade ininterrupta. O serviço pode ser interrompido para manutenção ou por razões técnicas sem aviso prévio.</p>
          </section>
