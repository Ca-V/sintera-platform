...
export const metadata = {
  title: "Termos de Uso — Sinctera",
  description: "Termos e condições de uso da plataforma Sinctera.",
}

export default function TermosPage() {
  const filePath = path.join(process.cwd(), "public/docs/terms-v2.0.txt")
