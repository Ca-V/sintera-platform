        ...
        {items.map(item => (
          <div key={item.name} className="flex items-center justify-between px-3 py-2.5 rounded-xl border border-border/50">
            <div>
              ...
              <p className="font-body text-[11px] text-mauve/50">{item.unit}</p>
            </div>
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-border overflow-hidden">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="font-body text-xs text-mauve/60">Última medição</p>
          ...
          <div className="text-right">
            <p className="font-body text-xs text-mauve/60">Variação total</p>
            ...
            <div key={i} className="flex-1 rounded-t-md transition-all"
              style={{
                ...
                background: i === bars.length - 1
                  ? 'linear-gradient(to top, #E8A4B8, #C490D1)'
